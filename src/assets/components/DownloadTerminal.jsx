...
const CLIENT_DOWNLOAD = 'https://drive.google.com/file/d/1OIgQfa__rK57UougnWaGVXmar-FZXGEi/view?usp=sharing'
const LAUNCHER_DOWNLOAD = 'https://drive.google.com/file/d/1fOn4oyl19xDTafi-EvCVo6Tg5A6OkFok/view?usp=sharing'

const STEPS = [
  {
    num: '01',
    title: 'BAIXE O CLIENTE',
    desc: 'Cliente completo via Google Drive (~36 GB). Extraia numa pasta de sua preferência.',
    color: 'var(--gold)',
  },
  {
    num: '02',
    title: 'BAIXE O LAUNCHER',
    desc: 'Baixe o SamuraiCrowLauncher.exe e coloque-o DENTRO da pasta do cliente extraído.',
    color: '#5865F2',
  },
  {
    num: '03',
    title: 'EXECUTE O LAUNCHER',
    desc: 'Abra o SamuraiCrowLauncher.exe. Ele atualiza o jogo e abre pra você. Pronto!',
    color: '#4CAF50',
  },
  {
    num: '04',
      ...
      <div className="container">
        ...
        <div style={{ textAlign: 'center', marginBottom: '5rem' }}>
          ...
          <p style={{
            ...
            Baixe o cliente e o launcher abaixo. Em caso de dúvida, nosso Discord tem suporte 24/7.
          </p>
        </div>
