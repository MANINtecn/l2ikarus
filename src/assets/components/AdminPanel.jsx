...
const ALL_CLASSES = [
  ...
  { id: 44, name: "Orc Fighter" },
  { id: 45, name: "Orc Raider" },
  { id: 46, name: "Destroyer" },
  { id: 47, name: "Monk" },
  { id: 48, name: "Tyrant" },
  { id: 49, name: "Orc Mystic" },
  { id: 50, name: "Orc Shaman" },
  { id: 51, name: "Overlord" },
  { id: 52, name: "Warcryer" },
  { id: 53, name: "Dwarf Fighter" },
  ...
  { id: 118, name: "Maestro" },
  { id: 192, name: "Jin Kamael Soldier" },
  { id: 125, name: "Trooper" },
  { id: 193, name: "Soul Finder" },
  { id: 126, name: "Warden" },
  { id: 127, name: "Beserker" },
  { id: 194, name: "Soul Breaker" },
  { id: 130, name: "Arbalester" },
  { id: 131, name: "Doombringer" },
  { id: 195, name: "Soul Hound" },
  { id: 134, name: "Trickster" },
  { id: 196, name: "Death Pilgrim" },
  { id: 197, name: "Death Blade" },
  { id: 198, name: "Death Messenger" },
  { id: 199, name: "Death Knight" },
  { id: 200, name: "Death Pilgrim" },
  { id: 201, name: "Death Blade" },
  { id: 202, name: "Death Messenger" },
  { id: 203, name: "Death Knight" },
  { id: 204, name: "Death Pilgrim" },
  { id: 205, name: "Death Blade" },
  { id: 206, name: "Death Messenger" },
  { id: 207, name: "Death Knight" },
  { id: 208, name: "Sylph Gunner" },
  { id: 209, name: "Sharpshooter" },
  { id: 210, name: "Wind Sniper" },
  { id: 211, name: "Storm Blaster" },
  { id: 217, name: "Orc Lancer" },
  { id: 218, name: "Rider" },
  { id: 219, name: "Dragoon" },
  { id: 220, name: "Vanguard Rider" },
  { id: 221, name: "Assassin" },
  { id: 222, name: "Assassin" },
  { id: 223, name: "Assassin" },
  { id: 224, name: "Assassin" },
  { id: 225, name: "Assassin" },
  { id: 226, name: "Assassin" },
  { id: 227, name: "Assassin" },
  { id: 228, name: "Assassin" },
  { id: 236, name: "Element Weaver" },
  { id: 237, name: "Element Weaver" },
  { id: 238, name: "Element Weaver" },
  { id: 239, name: "Element Weaver" },
  { id: 240, name: "Divine Templar" },
  { id: 241, name: "Divine Templar" },
  { id: 242, name: "Divine Templar" },
  { id: 243, name: "Divine Templar" },
  { id: 247, name: "Warg" },
  { id: 248, name: "Warg" },
  { id: 249, name: "Warg" },
  { id: 250, name: "Warg" },
  { id: 251, name: "Blood Rose" },
  { id: 252, name: "Blood Rose" },
  { id: 253, name: "Blood Rose" },
  { id: 254, name: "Blood Rose" },
  { id: 260, name: "Ashigaru" },
  { id: 261, name: "Hatamoto" },
  { id: 262, name: "Ronin" },
  { id: 263, name: "Samurai" },
]
